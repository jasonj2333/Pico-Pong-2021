...
button = machine.Pin(16, machine.Pin.IN, machine.Pin.PULL_DOWN) # start button
start_button = machine.Pin(15, machine.Pin.IN, machine.Pin.PULL_DOWN) # level button

global level1, level2,level3
level1 = machine.Pin(14, machine.Pin.OUT) # level 1 led
level2 = machine.Pin(13, machine.Pin.OUT) #level 2 led
level3 = machine.Pin(11, machine.Pin.OUT) #level 3 led
led_one_player_game = machine.Pin(17, machine.Pin.OUT) #training mode - 1 player game - led
